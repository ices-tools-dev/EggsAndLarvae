...
indexSubset <- subset(indexALL,
  ...
  # delivery of Index (this is for multiple years only)
  ...
  MIK_NosPerRect$year <- 2024
  
  
  write.table(MIK_NosPerRect, 'AnzRects_database_MM_060825.txt',
              append=TRUE, sep=",", row.names = F)
...
#   dir.create("results")
# }
write.table(MIK_NosPerRect, file = file.path("results", "AnzRects_database_MM_060825.txt"))
